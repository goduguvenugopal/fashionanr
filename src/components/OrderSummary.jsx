...
const OrderSummary = () => {
  ...
  const incrementFunc = (change) => {
    ...
    toast.success(`You have Changed ${data.title} QUANTITY '${data.quantity + 1}'`);
      ...
      <div className='container bg-white py-5 pb-3 pt-3 px-3' id='single-product-main-card'>
        ...
        <div className='bg-white  pt-4 pb-2 '>
          ...
          <div className='bg-white pt-4 text-end '>
            <Link to={`/product/id/itemId/${data._id}`}>   <button className='buy-bt bg-warning text-dark fw-bold'>Continue</button></Link>
